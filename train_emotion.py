...
transform = transforms.Compose([
    ...
    transforms.RandomAffine(degrees=10, shear=5),  # More transformation
...
for param in model.layer4.parameters():  # Fine-tune layer4
...
torch.save(model.state_dict(), "emotion_model_resnet50.pth")
